...
import net.bless.armoreq.equations.element.ElementFormatException;
import net.bless.armoreq.equations.element.number.Number;
import net.bless.armoreq.equations.element.number.Variable;
import net.bless.armoreq.equations.element.number.VariablePool;
import net.bless.armoreq.equations.element.operators.Absolute;
import net.bless.armoreq.equations.element.operators.Addition;
import net.bless.armoreq.equations.element.operators.Ceiling;
import net.bless.armoreq.equations.element.operators.Division;
import net.bless.armoreq.equations.element.operators.Floor;
import net.bless.armoreq.equations.element.operators.LeftShift;
import net.bless.armoreq.equations.element.operators.Multiplication;
import net.bless.armoreq.equations.element.operators.Random;
import net.bless.armoreq.equations.element.operators.RightShiftSigned;
import net.bless.armoreq.equations.element.operators.RightShiftUnsigned;
import net.bless.armoreq.equations.element.operators.Round;
import net.bless.armoreq.equations.element.operators.Subtraction;
/*
