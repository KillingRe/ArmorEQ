...
//import net.bless.armoreq.listeners.BowFireListener;
import net.bless.armoreq.listeners.EntityDamageListener;
//import net.bless.armoreq.listeners.FishListener;
//import net.bless.armoreq.listeners.LoginListener;
//import net.bless.armoreq.listeners.LogoutListener;
import net.bless.armoreq.listeners.ToolUseEvent;
//import net.bless.armoreq..listeners.WorldChangeListener;
...
public class NeverBreak extends JavaPlugin {
	...
	public void onDisable() {
		//Disable message
		log.info("[ArmorEQ] ArmorEQ v" + this.getDescription().getVersion() + " by thebiologist13 has been disabled!");
	}
