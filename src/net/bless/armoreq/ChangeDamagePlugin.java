...
import net.bless.armoreq.equations.ExpressionParser;
...
import net.bless.armoreq.hooks.ArmorHook;
//import vacuum.changedamage.hooks.PotionHook;
import net.bless.armoreq.listeners.DamageListener;
        ...
        private void loadArmor() {
                ...
                for(String s : section.getKeys(false)){
                        ...
                        for(String str : sub.getKeys(false)){
                                try{
                                        int i;
                                        try{//needs to be changed to a lore so we can add it to armoreq
